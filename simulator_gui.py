...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 370, 201, 111))
        ...
        self.doubleSpinBox_period.setDecimals(2)
        self.doubleSpinBox_period.setMinimum(0.1)
        ...
        self.doubleSpinBox_stopTime.setMinimum(1.0)
